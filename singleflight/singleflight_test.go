...
func TestDo(t *testing.T) {
	...
	v, err, _ := g.Do("key", 0, func() (interface{}, error) {
		return "bar", nil
	})
...
func TestForget(t *testing.T) {
	...
	go func() {
		g.Do("key", 0, func() (i interface{}, e error) {
			close(firstStarted)
			<-unblockFirst
			close(firstFinished)
			return
	...
	secondResult := g.DoChan("key", 0, func() (i interface{}, e error) {
		<-unblockSecond
		return 2, nil
	})
	...
	thirdResult := g.DoChan("key", 0, func() (i interface{}, e error) {
		return 3, nil
	})
...
func TestPanicDoChan(t *testing.T) {
	...
	if os.Getenv("TEST_PANIC_DOCHAN") != "" {
		...
		ch := g.DoChan("", 0, func() (interface{}, error) {
